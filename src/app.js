 ...
 *
 * The floors were found by looking rather than reasoned: below about 32%
 * saturation the dark theme's white mix takes the hue out of it and the left of
 * the grid goes grey, which is exactly what these bounds exist to prevent.
 */
var HUE_STEPS = 360;
var SATS = [38, 52, 66, 80, 94];
var LUMS = [62, 51, 40, 29];
